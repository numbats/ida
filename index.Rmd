...
- Nitika: 
- Cynthia:
- Nick: Monday 10:30-11:30 **Menzies W1105**
- Nick: Wednesday 12:30-1:30 **Menzies W1105**
...
midsem_break <- 10 # after which week
...
schedule %>% 
  mutate(Instructor = cell_spec(
    Instructor, "html",
    color = factor(x = Instructor, 
                   levels = unique(Instructor), 
                   labels = monash_pals[seq_len(n_distinct(Instructor))])
  )) %>% 
  kable(escape = FALSE, 
        align = c("c", "c", "c", "c", "l", "l")) %>% 
