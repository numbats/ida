...
---
# (My) Motivation for missing data

```{r show-missing-data, out.width = "50%", echo = FALSE}
include_graphics("images/missing-data-paper.jpg")
```

_From ["Using decision trees to understand structure in missing data "](https://bmjopen.bmj.com/content/5/6/e007450.full)_

???

I was handed a dataset in my PhD which had more than 65% of the data missing. 
