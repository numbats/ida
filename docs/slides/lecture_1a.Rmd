...
Make sure you've completed the previous exercise ("create your first data visualisation") before moving on to part 2 (available at [this link]()).
...
---
class: informative
# Course Website: http://ida-monash.netlify.com
...
- Before 6pm **This Friday**, you need to complete the 10 question **Lab Exercise** on ED (insert date here)
- Before 4pm **Mext Monday** you need to complete the 10 question **Lab Exercise** on ED. (insert date here)
...
*NOTE: Reading assignment on ED site due by 12pm before Class on Wednesday*
