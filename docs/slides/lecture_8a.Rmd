...
Perhaps not that exciting... What's the issue?
...
darwin6_words %>%
  top_n(n = 20, wt = n) %>%
  ggplot(aes(x = n, y = fct_reorder(word, n))) + geom_point() + labs(y = "")
```
