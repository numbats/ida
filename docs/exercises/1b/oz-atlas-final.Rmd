...
If you are good at recognising the shape of Australia, you might realise that the sightings are all along the east coast of Victoria!
...
```{r echo=TRUE}
library(leaflet)
leaflet(platypus_vic) %>% 
  addTiles() %>%
  addCircleMarkers(clusterOptions = markerClusterOptions())
```

Are there platypus sightings near you?
