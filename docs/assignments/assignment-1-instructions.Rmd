---
title: "Instructions for Assignment 1, Semester 1, 2020"
...
> Amelia has managed to find this treasure trove of data - get this: crime statistics in Victoria for the past years! Unfortunately, Amelia just left on holiday to New Zealand, and won't be back now for a while. They discovered this dataset the afternoon before they left on holiday, and got started on doing some data analysis.
...
* You can find the assignment on the `rstudio.cloud` workspace, under the name: "assignment-1-2020-s1"
* It is also on the website as well, [here](http://ida.numbat.space/assignment/assignment1.zip) if you would like to run it locally. 
