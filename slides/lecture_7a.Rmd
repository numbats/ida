...
```{r paris-auction-market, echo = FALSE}
...
Make sure we explicitly flag this as extension material (maybe a special “orange/red” slide class to flag this.
