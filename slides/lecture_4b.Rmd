...
gap_life <- read_csv(here::here("slides/data/gap_life.csv"))
gap_life_au <- read_csv(here::here("slides/data/gap_life_au.csv"))
gap_income <- read_csv(here::here("slides/data/gap_income.csv"))
gap_income_au <- read_csv(here::here("slides/data/gap_income_au.csv"))
gap_co2 <- read_csv(here::here("slides/data/gap_co2.csv"))
gap_co2_au <- read_csv(here::here("slides/data/gap_co2_au.csv"))
...
```{r plot, fig.height = 8, fig.width = 12, out.width = "60%"}
ggplot(gap_au,
       aes(x = gdp,
           y = life_expectancy)) + 
  geom_point()
